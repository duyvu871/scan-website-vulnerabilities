...
class Browser {
    constructor() {
        ...
        this.puppeteerPath = path.join(isDev ? process.cwd() : process.resourcesPath, 'build-resources/packages/chrome-win64/chrome.exe');
    }
...
const browser = () => {
    return CreateBrowser({
        ...
        executablePath: path.join(isDev ? process.cwd() : process.resourcesPath, 'build-resources/packages/chrome-win64/chrome.exe'),
        channel: 'chrome'
    });
}
